                ...
                <div className=' bg-gray-800 px-10 py-10 rounded-xl '>
                    ...
                    <div>
                        <input type="number"
                            ...
                            onChange={(e) => setProducts({ ...products, originalPrice: e.target.value })}
                            name='price'
                            className=' bg-gray-600 mb-4 px-2 py-2 w-full lg:w-[20em] rounded-lg text-white placeholder:text-gray-200 outline-none'
                    ...
                    <div>
                        <input type="number"
                            ...
                            onChange={(e) => setProducts({ ...products, discountPercentage: e.target.value })}
                            className=' bg-gray-600 mb-4 px-2 py-2 w-full lg:w-[20em] rounded-lg text-white placeholder:text-gray-200 outline-none'
                    ...
                    <div>
                        <input type="number"
                            ...
                            onChange={(e) => setProducts({ ...products, productRating: e.target.value })}
                            className=' bg-gray-600 mb-4 px-2 py-2 w-full lg:w-[20em] rounded-lg text-white placeholder:text-gray-200 outline-none'
