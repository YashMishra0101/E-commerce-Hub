...
export default function Footer() {
  ...
  return (
    <footer className="text-gray-600 body-font bg-gray-300" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }}>
      <div className="container px-5 py-20 mx-auto" data-aos="fade-up" >
        <div className="flex flex-wrap md:text-left text-center order-first">
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-8">
              <li>
                <a href='/home' className="text-gray-600 hover:text-gray-800" style={{ color: mode === 'dark' ? 'white' : '' }}>Home</a>
              </li>
              <li>
                <a href="/order" className="text-gray-600 hover:text-gray-800" style={{ color: mode === 'dark' ? 'white' : '' }}>Order</a>
              </li>
              <li>
                <a href='/profile' className="text-gray-600 hover:text-gray-800" style={{ color: mode === 'dark' ? 'white' : '' }}>Profile</a>
              </li>
              <li>
        ...
        <div className= "flex lg:flex-wrap lg:justify-start lg:items-center gap-5 mt-14">
          ...
          <a href="#">
            <img
              src={PlayStoreImg}
              alt="Play store"
              className="max-w-[90px] sm:max-w-[100px] md:max-w-[150px]"
            />
          </a>
          <a href="#">
            <img
      ...
      <div className="bg-pink-600" style={{ backgroundColor: mode === 'dark' ? 'rgb(55 57 61)' : '', color: mode === 'dark' ? 'white' : '', }}>
        <div className="container px-5 py-3 mx-auto flex items-center sm:flex-row flex-col">
          ...
          <p className="text-sm text-black sm:ml-6 sm:mt-0 mt-4" style={{ color: mode === 'dark' ? 'white' : '' }}>© 2024 E-bharat —
            <a href="https://twitter.com/knyttneve" rel="noopener noreferrer" className="text-black ml-1" target="_blank" style={{ color: mode === 'dark' ? 'white' : '' }}>www.ebharat.com</a>
          </p>
          <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
            <a className="text-black" style={{ color: mode === 'dark' ? 'white' : '' }}>
              <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} className="w-5 h-5" viewBox="0 0 24 24">
                <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z" />
              </svg>
            </a>
            <a className="ml-3 text-black" style={{ color: mode === 'dark' ? 'white' : '' }}>
              <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} className="w-5 h-5" viewBox="0 0 24 24">
