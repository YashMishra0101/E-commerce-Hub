        ...
        <>
            <div className="container mx-auto">
                <div className="tab container mx-auto ">
                    <Tabs defaultIndex={0} className=" " data-aos="zoom-in" data-aos-duration="1000">
                        <TabList className="md:flex md:space-x-5   grid grid-cols-3 text-center gap-4   md:justify-center mb-10 ">
                            <Tab>
